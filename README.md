...
- Detects **fraudulent or suspicious behavior**
- Uses **Machine Learning** for fraud analysis
- Keeps frontend, backend, and ML **cleanly separated**
- Is designed for **real-world use**
